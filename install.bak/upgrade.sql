...
INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES (1, 1, '公分', 'cm') ON DUPLICATE KEY UPDATE length_class_id=length_class_id;
INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES (2, 1, '公厘', 'mm') ON DUPLICATE KEY UPDATE length_class_id=length_class_id;
INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES (3, 1, '英吋', 'in') ON DUPLICATE KEY UPDATE length_class_id=length_class_id;
...
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (1, 1, '公斤', 'kg') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (2, 1, '公克', 'g') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (3, 1, '磅 ', 'lbs') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (4, 1, '盎司', 'ozs') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (5, 1, '磅 ', 'lb') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
INSERT INTO `oc_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES (6, 1, '盎司', 'oz') ON DUPLICATE KEY UPDATE weight_class_id=weight_class_id;
